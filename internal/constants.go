...
const (
	...
	KeyActiveAccount     ContextKey = "active-account"
	...
	LowercaseEKS         string     = "eks"
	UppercaseEKS         string     = "EKS"
	LowercaseAPIGW       string     = "apigw"
	UppercaseAPIGW       string     = "APIGW"
	LowercaseBedrock     string     = "bedrock"
	UppercaseBedrock     string     = "BEDROCK"
	LowercaseBilling     string     = "billing"
	UppercaseBilling     string     = "BILLING"
	Help                  string     = "help"
	LowercaseH            string     = "h"
	QuestionMark          string     = "?"
	Quit                  string     = "quit"
